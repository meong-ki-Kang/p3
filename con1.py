...
scaler4.fit(kospi_x)
kospi_x=scaler4.transform(kospi_x)
...
kospi_x=split_data(kospi_x, size)
sk_x=sk_x[:samsung_x.shape[0],:]
db_x=db_x[:samsung_x.shape[0],:]
kospi_x=kospi_x[:samsung_x.shape[0],:]
...
np.save('kospi_x.npy', arr=kospi_x)
np.save('kospi_x_predict.npy', arr=kospi_x_predict)

# train, test 분리
samsung_x_train, samsung_x_test, samsung_y_train, samsung_y_test=train_test_split(samsung_x, samsung_y, train_size=0.8)
sk_x_train, sk_x_test, db_x_train, db_x_test, kospi_x_train, kospi_x_test=train_test_split(sk_x, db_x, kospi_x, train_size=0.8)
...
kospi_x_predict=kospi_x_predict.reshape(1,5,4)



######### 2. LSTM 회귀모델
samsung_input1=Input(shape=(5,3))
samsung_layer1=LSTM(40, activation='relu')(samsung_input1)
samsung_layer2=Dense(90,activation='relu')(samsung_layer1)
samsung_layer2=Dropout(0.1)(samsung_layer2)
samsung_layer3=Dense(45,activation='relu')(samsung_layer2)
samsung_layer4=Dense(20,activation='relu')(samsung_layer3)
samsung_output=Dense(1)(samsung_layer4)

sk_input1=Input(shape=(5,4))
sk_layer1=LSTM(30, activation='relu')(sk_input1)
sk_layer1=Dropout(0.2)(sk_layer1)
sk_layer2=Dense(100, activation='relu')(sk_layer1)
sk_layer3=Dropout(0.2)(sk_layer2)
sk_layer3=Dense(50, activation='relu')(sk_layer3)
sk_layer3=Dropout(0.2)(sk_layer3)
sk_layer3=Dense(25, activation='relu')(sk_layer3)
sk_output=Dense(1)(sk_layer3)

db_input1=Input(shape=(5,4))
db_layer1=LSTM(30, activation='relu')(db_input1)
db_layer1=Dropout(0.2)(db_layer1)
db_layer2=Dense(100, activation='relu')(db_layer1)
db_layer3=Dropout(0.2)(db_layer2)
db_layer3=Dense(50, activation='relu')(db_layer3)
db_layer3=Dropout(0.2)(db_layer3)
db_layer3=Dense(25, activation='relu')(db_layer3)
db_output=Dense(1)(db_layer3)

kospi_input1=Input(shape=(5,4))
kospi_layer1=LSTM(30, activation='relu')(kospi_input1)
kospi_layer1=Dropout(0.2)(kospi_layer1)
kospi_layer2=Dense(100, activation='relu')(kospi_layer1)
kospi_layer3=Dropout(0.2)(kospi_layer2)
kospi_layer3=Dense(50, activation='relu')(kospi_layer3)
kospi_layer3=Dropout(0.2)(kospi_layer3)
kospi_layer3=Dense(25, activation='relu')(kospi_layer3)
kospi_output=Dense(1)(kospi_layer3)

#병합
merge1=concatenate([samsung_output, sk_output, db_output, kospi_output])

output1=Dense(100)(merge1)
output2=Dense(50)(output1)
output3=Dense(25)(output2)
output4=Dense(10)(output3)
output5=Dense(1)(output4)

model=Model(inputs=[samsung_input1, sk_input1, db_input1, kospi_input1], outputs=output5)
...
hist=model.fit([samsung_x_train, sk_x_train, db_x_train, kospi_x_train], samsung_y_train, epochs=5000, batch_size=100, validation_split=0.2, callbacks=[es, cp])


#4. 평가, 예측
loss=model.evaluate([samsung_x_test, sk_x_test, db_x_test, kospi_x_test], samsung_y_test, batch_size=100)
samsung_y_predict=model.predict([samsung_x_predict, sk_x_predict, db_x_predict, kospi_x_predict])
...
plot_rst.plot(samsung_x, label='Real')
plot_rst.plot(hist, label='Predict')
plot_rst.legend()
plt.show()
